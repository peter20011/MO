...
//Alokacja i wype�nienie macierzy A
double **matrix(){
...
//Alokacja i wype�nienie wektora b
double *vector(){
...
//Obliczanie ety, v - wektor przechowuj�cy  iloczyn l[i]*eta^-1
...
//Usuwanie z pami�ci zaalokowanych element�w
